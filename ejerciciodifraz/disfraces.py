# Funcion para verificar la edad del usuario
def verificar_ingreso():
    while True:
        # Solicita al usuario que ingrese su edad
        edad = int(input("Ingresa tu edad: "))
        
        # Si la edad es 17 o mas permite el acceso
        if edad >= 17:
...
# Funcion para verificar la tematica del disfraz del usuario
def verificar_tematica():
    ...
    while True:
        ...
        disfraz = input("Ingresa de que vas disfrazado: ")
...
def gestionar_acompanantes():
    ...
    while True:
        # Solicita al usuario si llevara acompanantes
        ...
        if respuesta == 's':
            ...
            # Verifica si el numero de acompanantes es menor o igual al limite
            ...
            print("Bienvenido! No traeras acompanantes.")
            break
        else:
...
# Funcion para gestionar si el usuario llevara mascotas y cuantas
def mascota():
    ...
    while True:
        ...
        respuesta = input("¿Llevaraas mascotas? (s/n): ").lower()

        # Si la respuesta es 's', solicita el numero de mascotas
        if respuesta == 's':
            num_mascotas = int(input("¿Cuantas mascotas llevaras?: "))

            # Verifica si el numero de mascotas es menor o igual al limite
